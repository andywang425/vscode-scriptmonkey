...
export function activate(context: vscode.ExtensionContext) {
  context.subscriptions.push(
    codeSnippetsCompletionProvider,
    GM_APIsCompletionProvider,
    GMdotAPIsCompletionProvider,
    GMmetaCompletionProvider,
    GMotherCompletionProvider,
    GM_APIsHoverProvider,
    GMdotAPIsHoverProvider,
    GMotherHoverProvider
  )
}
