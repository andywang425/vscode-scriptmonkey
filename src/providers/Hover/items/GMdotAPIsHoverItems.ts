...
const GMdotAPIsHoverItems = [
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM.addElement(parentNode?: HTMLElement, tag: string, attributes: { [key: string]: string | boolean | number }): HTMLElement'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM.registerMenuCommand(caption: string, onClick: (event: MouseEvent | KeyboardEvent) => void): number | string'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'async function GM.getResourceURL(name: string, isBlobUrl?: boolean): Promise<string>'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            ...
            {
                add: 'markdown',
                value: '**Notice:** `GM.info` in different userscript managers may have different properties.  \nPlease check the documentation of the userscript manager you are using.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        contents: [
            ...
            {
                add: 'code',
                value: 'function GM.notification(text: string, title: string, image: string,\nonclick: () => any): void | () => Promise'
            },
            {
                add: 'markdown',
            ...
            {
                add: 'code',
                value: 'function GM.notification(options: {\n\ttext: string,\n\ttitle?: string,\n\timage?: string,\n\tonclick?: () => any,\n\tondone?: () => any,\n\thighlight?: boolean,\n\tsilent?: boolean,\n\ttimeout?: number\n}): void | () => Promise'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM.openInTab(url: string,\n\toptions?: {\n\t\tactive?: boolean,\n\t\tcontainer?: number,\n\t\tinsert?: boolean,\n\t\tpinned?: boolean\n\t} | boolean\n): { onclose: () => void, closed: boolean, close: () => void }'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM.setClipboard(data: string, type: string | { type: string, mimetype: string}): void'
            },
            {
                add: 'markdown',
