const GM_APIsHoverItems = [
    {
        ...
        contents: [
            ...
            {
                add: 'markdown',
                value: '**Notice:** `GM_info` in different userscript managers may have different properties.  \nPlease check the documentation of the userscript manager you are using.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM_addElement(parentNode?: HTMLElement, tag: string, attributes: { [key: string]: string | boolean | number }): HTMLElement'
            },
            {
                add: 'markdown',
                value: 'Creates an HTML element specified by `tag_name` and applies all given `attributes` and returns the injected HTML element. If a `parent_node` is given, then it is attached to it or to document head or body otherwise.  \n  \nFor suitable `attributes`, please consult the appropriate documentation. For example:  \n- [script tag](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/script)  \n- [img tag](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/img)  \n- [style tag](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/style)  \n'
            },
            {
                add: 'code',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM_addValueChangeListener(name: string, callback: (name: string, oldValue: any, newValue: any, remote: boolean) => void): number'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM_registerMenuCommand(caption: string, onClick: (event: MouseEvent | KeyboardEvent) => void): number | string'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            ...
            {
                add: 'markdown',
                value: 'Unregister a menu command that was previously registered by `GM_registerMenuCommand`.'
            }
        ]
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM_openInTab(url: string,\n\toptions?: {\n\t\tactive?: boolean,\n\t\tcontainer?: number,\n\t\tinsert?: boolean,\n\t\tpinned?: boolean\n\t} | boolean\n): { onclose: () => void, closed: boolean, close: () => void }'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            ...
            {
                add: 'code',
                value: 'const responseObject: {\n\treadyState: number,\n\tstatus: number,\n\tstatusText: string,\n\tresponseText: string,\n\tresponseHeaders: string,\n\tresponseXML?: Document,\n\tresponse: string | Blob | ArrayBuffer | Document | Object | null,\n\tfinalUrl: string,\n\tcontext?: any\n}'
            },
            {
                add: 'markdown',
                value: 'Makes a request like XMLHttpRequest, with some special capabilities, not restricted by same-origin policy.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        contents: [
            ...
            {
                add: 'code',
                value: 'function GM_notification(text: string, title: string, image: string,\nonclick: () => any): void | () => Promise'
            },
            {
                add: 'markdown',
                value: '- Using an object:  \n'
            ...
            {
                add: 'code',
                value: 'function GM_notification(options: {\n\ttext: string,\n\ttitle?: string,\n\timage?: string,\n\tonclick?: () => any,\n\tondone?: () => any,\n\thighlight?: boolean,\n\tsilent?: boolean,\n\ttimeout?: number\n}): void | () => Promise'
            },
            {
                add: 'markdown',
    ...
    },
    {
        ...
        contents: [
            {
                add: 'code',
                value: 'function GM_setClipboard(data: string, type: string | { type: string, mimetype: string}): void'
            },
            {
                add: 'markdown',
