...
const GMdotAPIsCompletionItems = [
    ...
    },
    {
        ...
        documentation: [
            {
                add: 'markdown',
                value: '(async) Get the base64 encoded URI of a predefined @resource tag at the script header.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        documentation: [
            {
                add: 'markdown',
                value: 'An object that exposes information about the current userscript. `GM.info` in different userscript managers may have different properties. Please check the documentation of the userscript manager you are using.'
            }
        ]
    },
    {
