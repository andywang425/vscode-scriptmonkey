...
const GM_APIsCompletionItems = [
    {
        ...
        documentation: [
            {
                add: 'markdown',
                value: 'An object that exposes information about the current userscript. `GM_info` in different userscript managers may have different properties. Please check the documentation of the userscript manager you are using.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        documentation: [
            {
                add: 'markdown',
                value: 'Unregister a menu command that was previously registered by `GM_registerMenuCommand` with the given menu command ID.'
            }
        ]
    },
    {
